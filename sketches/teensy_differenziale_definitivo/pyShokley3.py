...
def legge(x, I0, a, Rd):
    ...
    return a*pylab.log((x/I0)+1.)+(x)*Rd
#b = c/I0 + 1.
...
for i in range(50):
    for i in range(len(y)):
        dw[i] = pylab.sqrt(((a2*dy[i]*(a1/(y[i]+a1)))+a3*dy[i])**2 + (dx[i])**2)
...
#print("c = %f +- %f" %(a4, da4))
#print("b = %f +- %f" %(a5, da5))
#print("b = %f +- %f" %(a5, da5))bucket = numpy.linspace(1./1000000, max(y)+0.01, 1000)
